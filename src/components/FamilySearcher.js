...
class FamilySearcher extends Component {
  ...
  sorts = (filters) => {
    var results = [
      ...
      ["headInsuree__arabLastName", true],
      ["headInsuree__arabOtherNames", true],
  ...
  itemFormatters = (filters) => {
    var formatters = [
      ...
      (family) => (!!family.headInsuree ? family.headInsuree.arabLastName : ""),
      (family) => (!!family.headInsuree ? family.headInsuree.arabOtherNames : ""),
